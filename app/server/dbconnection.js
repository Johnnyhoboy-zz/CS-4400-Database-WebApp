...
var suspendedCardsData = function(sort, desc, callback) {
...
var updateHistory = function(username, start, end, sort, desc, callback) {
    ...
    + "AND (StartTime BETWEEN ?AND ?) AND Trip.BreezecardNum NOT IN (SELECT BreezecardNum FROM Conflict) ORDER BY " + sort + " " + desc;
...
var deleteIfConflict = function(BreezecardNum) {
